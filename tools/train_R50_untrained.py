...
train_args.snapshot = ''
#train_args.snapshot = 'epoch_26_loss_1.41701_acc_0.67519_acc-cls_0.34707_mean-iu_0.26590_fwavacc_0.50918_f1_0.38539_lr_0.0000527714.pth'
...
def main():
    ...
    net = load_model(name=train_args.model, classes=train_args.nb_classes,
                     node_size=train_args.node_size, pretrained=False)
